...
@Mojo(name = "generate-binary-ebuild-for-pom", defaultPhase = LifecyclePhase.NONE, requiresProject = false, requiresDirectInvocation = true)
public class GenerateBinaryEbuildForPomMojo extends AbstractMojo {
	...
	public void execute() throws MojoExecutionException, MojoFailureException {
		...
		try {
			binEbuildTemplate = freemarkerConfig.getTemplate("pom-ebuild.ftl");
	...
	public MavenProject getProject() {
		...
		DefaultArtifact artifact = new DefaultArtifact(this.groupId, this.artifactId, this.version, SCOPE_COMPILE,
				"pom", this.classifier, new DefaultArtifactHandler());
		try {
